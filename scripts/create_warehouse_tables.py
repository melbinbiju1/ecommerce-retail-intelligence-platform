...
SQL_FILE_PATH = Path("sql/warehouse/create_warehouse_tables.sql")
LOG_DIR = Path("logs")
...
def main() -> None:
    ...
    try:
        ...
        write_log("SUCCESS | Warehouse tables created successfully")
        print("Warehouse tables created successfully.")
        print("Log file created: logs/warehouse_load.log")

    except Exception as error:
        write_log(f"FAILED | Warehouse table creation failed | {error}")
        print(f"Warehouse table creation failed: {error}")
        raise
